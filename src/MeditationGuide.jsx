...
function MeditationGuide() {
  ...
  const meditationThemes = {
    nature: {
      ...
      sound: "src/assets/music/song1.mp3",
      images: [
        {
          id: 1,
          title: "Mountain Lake",
    ...
    ocean: {
      name: "Ocean Serenity",
      sound: "src/assets/music/song2.mp3",
      images: [
        {
          id: 1,
          title: "Calm Waters",
    ...
    zen: {
      name: "Zen Garden",
      sound: "src/assets/music/song3.mp3",
      images: [
        {
          id: 1,
          title: "Stone Garden",
  ...
  const getMeditationRecommendation = () => {
    if (anxietyLevel === 0) {
      return {
        ...
        description:
          "Practice mindful breathing for 5-10 minutes to maintain your calm state.",
        techniques: [
      ...
      return {
        ...
        description:
          "Try these 15-minute meditation techniques to restore balance.",
        techniques: [
      ...
      return {
        ...
        description:
          "Focus on these soothing techniques for 20-30 minutes to reduce anxiety.",
        techniques: [
  ...
  useEffect(() => {
    ...
    if (isPlaying && timeLeft > 0) {
      ...
      const alarmSound = new Audio(
        "https://assets.mixkit.co/sfx/preview/mixkit-meditation-bell-timer-1190.mp3"
      );
  ...
  useEffect(() => {
    ...
    if (isPlaying) {
      slideshow = setInterval(() => {
        setCurrentImage(
          (prev) => (prev + 1) % meditationThemes[currentTheme].images.length
        );
          ...
          <div className="meditation-background">
            ...
            >
              <div className="background-overlay">
                <h3>
                  {meditationThemes[currentTheme].images[currentImage].title}
                </h3>
                <p>
                  {
                    meditationThemes[currentTheme].images[currentImage]
                      .description
                  }
                </p>
              </div>
